/**
  ...
  * @version 0.1.0
  * Class for storing different information about songs. Includes song title, music file name, artwork file name, and album name.
  */
...
public class SongDetails implements Comparable
{
   ...
   /**
     * Constructor that only need the title of the song and the general file name for both the music and artwork file
   ...
   /**
     * Constructor that takes a String for every field (song title, music file name, artwork file name, and album name).
     * @param title A String for the title of the song.
     ...
     */
   public SongDetails(String title, String musicFilename, String artFilename, String album)
   {
      this.title = title;
   ...
   /**
     * Creates a String containing all four fields seperated by new lines. The last line does not have a new line.
     * Could be used to print to a file while creating a songlist.
     * @return Returns a String containing all of the fields, title, music file name, art file name, and the album
     *         name. All of the fields are seperated by new lines. 
     */
   public String toString()
   {
      return String.format("%s\n%s\n%s\n%s", this.title, this.musicFilename, this.artFilename, this.album);
   }
   
   /**
     * Compares this SongDetails with the given Object.
     * Non-SongDetails always go after SongDetails, and "exit" always goes before any other song.
     * Sorts first by album name then by song title. Art and music file names do not play a role in comparing.
     * @param o An Object to compare this SongDetails with.
     * @return Returns an int less than 0 if this sorts before o, 0 is this equals o, or an int greater than 0 if this sorts after o.
     */
